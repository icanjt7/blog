...
tags:
  ...
  - unveil
quality_score: 73.0
cover_image: "https://loremflickr.com/1200/630/technology%2Cinnovation%2Ccircuit%2Cabstract?lock=9474"
...
### 스냅 전직 직원, 새로운 펀드 출시
스냅의 전직 직원들이 새로운 펀드를 출시했습니다. Ghost Angels라는 이름의 이 펀드는 소셜 미디어의 다음 세대를 지원하는 것을 목표로 합니다.

### 펀드의 주요 특징
| 특징 | 설명 |
| --- | --- |
| 펀드 이름 | Ghost Angels |
| 목표 | 소셜 미디어의 다음 세대를 지원 |
| 투자 대상 | 소셜 미디어 플랫폼과 서비스 |
| 투자자 | 스냅의 전직 직원 20명 |

### 새로운 기회
Ghost Angels는 소셜 미디어의 미래를 위해 필요한 기술과 서비스를 지원할 계획입니다. 스냅의 전직 직원들이 모여 만든 이 펀드는 새로운 기회를 제공할 것입니다. 자세한 정보는 [こちら](https://techcrunch.com/2026/05/30/snap-alums-unveil-ghost-angels-fund/)를 방문하세요.
