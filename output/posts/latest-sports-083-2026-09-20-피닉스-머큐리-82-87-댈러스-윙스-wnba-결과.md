---
title: "2026-09-20 피닉스 머큐리 82-87 댈러스 윙스 WNBA 결과"
...
2026-09-20 열린 WNBA 경기에서 **댈러스 윙스가 승리했습니다.** 최종 스코어는 피닉스 머큐리 82점, 댈러스 윙스 87점입니다.
...
- **승리 팀 주목 선수:** Paige Bueckers — 26 PTS, 3 STL
- **상대 팀 주목 선수:** Alyssa Thomas — 19 PTS, 10 REB, 11 AST

공식 스코어보드의 득점·리바운드·어시스트와 종합 기록을 기준으로 각 팀에서 눈에 띈 선수를 골랐습니다. 팀 결과와 개인 기록을 함께 보면, 패한 팀에서도 좋은 경기력을 보인 선수가 누구였는지 놓치지 않을 수 있습니다.

## 숫자로 본 승부

최종 점수 차는 **5점**입니다. 한두 번의 공격 성공 여부가 결과를 바꿀 수 있었던 접전입니다. 농구 결과를 볼 때는 득점 선두뿐 아니라 리바운드와 어시스트가 공격 기회를 어떻게 늘렸는지도 함께 확인할 필요가 있습니다.
...
- 승리 팀: **댈러스 윙스**
- 최종 점수: **피닉스 머큐리 82-87 댈러스 윙스**
- 승리 팀 주목 선수: **Paige Bueckers**
- 데이터 상태: 경기 종료·최종 결과
