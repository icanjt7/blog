...
- 본문에 '핵심 팩트 (Key Facts)' 또는 '주요 수치 (Stats)'라는 H2를 만들고, 출처에서 확인한 날짜·예산·규모·평점·관객수 등 객관적 사실을 3~4개의 불릿 목록으로 정리한다.
- 객관적 수치가 3개보다 적으면 기관·대상·장소처럼 출처로 검증 가능한 사실을 사용하며, 빈칸을 채우기 위해 추측하거나 창작하지 않는다.
