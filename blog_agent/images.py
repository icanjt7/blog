...
VISUAL_KEYWORDS: tuple[tuple[str, str], ...] = (
    ...
    # 기술 — 스마트폰/웨어러블/가젯
    ("아이폰", "iphone smartphone modern minimal"),
    ("갤럭시", "samsung smartphone modern display"),
    ("노트북", "laptop portable computer modern"),
    ("스마트워치", "smartwatch wearable wrist display"),
    ("워치", "smartwatch wearable wrist tech"),
    ("watch", "smartwatch wearable wrist device"),
    ("pixel", "smartphone google modern screen"),
    ("tracker", "wearable tracker compact device"),
    ("pebblebee", "wearable tracker compact gadget"),
    ("halo", "wearable device compact round"),
    ("태블릿", "tablet touchscreen digital screen"),
    ("헤드폰", "headphones audio wireless"),
    ("헤드셋", "headset audio wireless gaming"),
    ("이어폰", "earbuds audio wireless minimal"),
    ("카메라", "camera photography lens digital"),
    ("드론", "drone aerial sky modern"),
    ("로봇", "robot automation future"),
    ("전기차", "electric vehicle car clean energy"),
    ("자율주행", "autonomous vehicle car sensor"),
    # 기술 — 디바이스 일반
    ("스마트폰", "smartphone modern minimal screen"),
    ("모니터", "monitor display screen modern"),
    ("공유기", "router wifi network device"),
    ("키보드", "keyboard input device peripheral"),
    ("마우스", "mouse input device peripheral"),
    ("배터리", "battery power energy tech"),
    ("충전", "charging wireless power tech"),
    ("USB", "usb cable connector device"),
    ("블루투스", "bluetooth wireless device connection"),
    # 기술 — 기업/플랫폼
    ("microsoft", "software windows technology"),
    ("apple", "apple device minimal design"),
    ("google", "search cloud technology"),
    ("amazon", "cloud ecommerce technology"),
    ("meta", "social virtual technology"),
    ("samsung", "samsung device display modern"),
    ("playstation", "gaming console controller"),
    ("nintendo", "gaming handheld console"),
    ("xbox", "gaming console controller"),
    # 기술 — 소프트웨어/플랫폼/연구
    ("스펙", "technology device specification digital"),
    ("비교", "technology devices comparison review"),
    ("AI", "artificial intelligence neural network"),
    ("인공지능", "artificial intelligence neural network"),
    ("디지털", "digital technology abstract"),
    ("반도체", "semiconductor chip microprocessor"),
    ...
    ("앱", "mobile app software interface"),
    ("플랫폼", "cloud platform software abstract"),
    ("게임", "gaming esports interactive"),
    ("gaming", "gaming esports interactive"),
    ("software", "software development code"),
    ("launch", "technology product launch"),
    ("update", "software update technology"),
    ("review", "technology review device"),
    # 정책/경제
    ...
    ("당선인", "election civic government ballot public office"),
    ("공약", "civic policy document public office"),
...
class ImageAgent:
    ...
    def build_prompt(draft: Draft) -> str:
        ...
        category_moods = {
            ...
            "정치": "neutral civic election briefing, ballots, public buildings and policy documents without party logos",
