...
- `blog_agent/site.py`: 행정·공공입찰 상품 차단, Jaccard 임계치, 무관 상품 위젯 생략, 홈 공고 카드, 공식 출처 버튼, 고대비 CTA·혜택 배지·후기 말풍선, 입찰 카드/D-Day CSS·JS를 추가했습니다. 정책·복지 글도 연관도 기준을 통과한 상품만 제한적으로 노출합니다.
